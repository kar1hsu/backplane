...
Backplane is a modular Go admin framework designed as a practical foundation for real business applications. The backend uses Gin, GORM, Casbin, and JWT. The Vue 3 + Naive UI admin panel is bundled into the same binary with Go `embed`.
...
> This is the `naive-ui` branch. Its admin panel has been redesigned with [Naive UI](https://www.naiveui.com/).
...
<details>
<summary>View the core pages</summary>
...
├── web/admin/              # Vue 3 + Naive UI admin panel
...
Thanks to [Gin](https://gin-gonic.com/), [GORM](https://gorm.io/), [Casbin](https://casbin.org/), [Vue](https://vuejs.org/), [Naive UI](https://www.naiveui.com/), and the wider open-source community. This branch's admin redesign is built on Naive UI.
